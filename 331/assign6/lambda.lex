...
"-"          => (Tokens.MINUS (make_pos(yypos, 1)));
"/"          => (Tokens.DIVIDE (make_pos(yypos, 1)));
"%"          => (Tokens.MOD (make_pos(yypos, 1)));
"if"          => (Tokens.IF (make_pos(yypos, 1)));
"<"          => (Tokens.LT (make_pos(yypos, 1)));
">"          => (Tokens.GT (make_pos(yypos, 1)));
"="          => (Tokens.EQ (make_pos(yypos, 1)));
"&"          => (Tokens.AND (make_pos(yypos, 1)));
"|"          => (Tokens.OR (make_pos(yypos, 1)));
"!"          => (Tokens.NOT (make_pos(yypos, 1)));
"let"	     => (Tokens.LET (make_pos(yypos, 1)));
