...
public class HW05D extends JFrame {
    private int x;
    private int y;
    ...
    public void paint(Graphics g) {
        ...
        for (int i=0; i<rectangles.shapes.size(); i++) {
            ...
            g.drawRect((int)((Rectangle)rectangles.shapes.get(i)).getX(), (int)((Rectangle)rectangles.shapes.get(i)).getY(), (int)((Rectangle)rectangles.shapes.get(i)).getWidth(), (int)((Rectangle)rectangles.shapes.get(i)).getHeight());
        }
        ...
        for (int i=0; i<ovals.shapes.size(); i++) {
            ...
            g.drawOval((int)((Ellipse2D.Double)ovals.shapes.get(i)).getX(), (int)((Ellipse2D.Double)ovals.shapes.get(i)).getY(), (int)((Ellipse2D.Double)ovals.shapes.get(i)).getWidth(), (int)((Ellipse2D.Double)ovals.shapes.get(i)).getHeight());
        }
    }
